...
public class StreamReader {
	 ...
	 * http://yaml.org/spec/1.1/#simple key/ It must count code points, but it
	 * counts characters (to be fixed)
	 */
	...
	/**
	 * read the next length characters and move the pointer. if the last character
	 * is high surrogate one more character will be read
	 *
	...
	/**
	 * @return current position as number (in characters) from the beginning of the
	 *         stream
	 */
	public int getIndex() {
		return index;
